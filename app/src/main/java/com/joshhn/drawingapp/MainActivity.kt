    ...
    val requestPermission: ActivityResultLauncher<Array<String>> =
        registerForActivityResult(
            ...
            permissions.entries.forEach {
                ...
                if(isGranted){
                    Toast.makeText(this@MainActivity,"Permission granted for accessing media.", Toast.LENGTH_LONG).show()
                    ...
                    if(permissionName == Manifest.permission.READ_EXTERNAL_STORAGE) {
                        Toast.makeText(this@MainActivity,"Permission denied for accessing media.", Toast.LENGTH_LONG).show()
                    }
                }
...
//            shouldShowRequestPermissionRationale(Manifest.permission.READ_EXTERNAL_STORAGE)){
            ...
            showRationaleDialog("Application requires album access", "The album cannot accessed because the album access is denied")
        }else{
